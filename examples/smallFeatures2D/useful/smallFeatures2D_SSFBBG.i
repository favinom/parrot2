...
[sideset]
 ...
 boundary_id_new = '10'
 bottom_left = '0.33333333 -0.0001 0.0'
 top_right =   '0.66666667  1.0001 0.0'
 block_id = 0
[]
...
[BCs]
[./inflow]   type = NeumannBC   variable = pressure boundary = 10          value =  1.0 [../]
...
[Outputs]
 file_base = output_SSFBBG_${nxStringMoose} 
 nemesis = true
[]
