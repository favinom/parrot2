...
template <>
InputParameters validParams<ComputeFluxID>();

class ComputeFluxID : public GeneralUserObject
{
public:
  static InputParameters validParams();

  ComputeFluxID(const InputParameters & params);
